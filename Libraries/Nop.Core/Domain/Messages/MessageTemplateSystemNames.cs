namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Represents system name of notification about paid order (manual payment) by customer to notify store owner
        /// </summary>
        public const string OrderPaidImageUploadNotification = "OrderPaid.CustomerImageUploadNotification";
        ...
        /// <summary>
        /// Represents system name of notification to Store Owner about cancelled order
        /// </summary>
        public const string OrderCancelledStoreOwnerNotification = "OrderCancelled.StoreOwnerNotification";
