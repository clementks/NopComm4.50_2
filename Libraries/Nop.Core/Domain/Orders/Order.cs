...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity, ISoftDeletedEntity
    {
        ...
        /// <summary>
        /// Gets or sets the image uploaded as proof of payment.
        /// </summary>
        [DisplayName("Payment Image Uploaded")]
        public string PaymentImageUrl { get; set; }

        /// <summary>
        /// Gets or sets the date of image uploaded as proof of payment.
        /// </summary>
        public DateTime PaymentImageSubmitOnUtc { get; set; }
