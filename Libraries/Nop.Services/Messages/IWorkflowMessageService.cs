...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <summary>
        /// Sends an order paid image upload by customer notification to Store Owner
        /// </summary>
        /// <param name="order">Order instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>
        ...
        /// The task result contains the queued email identifier
        /// </returns>
        Task<IList<int>> SendOrderPaidImageUploadNotificationAsync(Order order, int languageId, string attachmentFilePath, string attachmentFileName);
