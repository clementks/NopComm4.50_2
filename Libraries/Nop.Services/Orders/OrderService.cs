...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        /// <summary>
        /// Gets PaymentImageUrl by CustomOrderNbr identifier
        /// </summary>
        ...
        /// </returns>
        public virtual async Task<string> GetPicturesByOrderIdAsync(string customOrderNbr)
        {

            var query = from p in _orderRepository.Table
                        orderby p.Id
                        where p.CustomOrderNumber == customOrderNbr
                        select p.PaymentImageUrl;

            var pics = await query.SingleAsync();
