...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageNatureOfBusiness = new() { Name = "Admin area. Manage NatureOfBusiness", SystemName = "ManageNatureOfBusiness", Category = "Customers" };
