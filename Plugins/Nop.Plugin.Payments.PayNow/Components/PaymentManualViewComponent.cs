...
namespace Nop.Plugin.Payments.PayNow.Components
{
    [ViewComponent(Name = "PaymentPayNow")]
    public class PaymentPayNowViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.PayNow/Views/PaymentInfo.cshtml", model);
        }
    }
}
